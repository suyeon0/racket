package com.racket.api.delivery.adapter.out.client.feign.hanjin
...
class HanjinFakeFeignClient : HanjinDeliveryApiFeignClient {
    ...
    companion object {
        ...
        private val jsonFile = File("api-interface/src/main/resources/delivery/tracking-hanjin.json")
